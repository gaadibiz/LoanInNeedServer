...
echo "PWD: $(pwd)"
echo ""
echo "Listing /app directory (shallow):"
ls -la /app || echo "❌ ERROR: Cannot list /app"
echo ""
...
echo "------------------------------------------------------------"
ls -la /app/prisma || echo "❌ ERROR: /app/prisma missing!"
echo ""

echo "▶️  Step 6: Verifying Prisma Client"
echo "------------------------------------------------------------"
ls -la /app/node_modules/@prisma || echo "❌ ERROR: @prisma missing!"
echo ""
ls -la /app/node_modules/.prisma || echo "❌ ERROR: .prisma engines missing!"
echo ""
